  ...
  return (
    <Layout>
      <div className="max-w-2xl mx-auto text-center py-20">
        <h1 className="text-5xl font-bold text-yellow-400 mb-4">🚀 AI Studio</h1>
        <p className="text-2xl text-gray-300 mb-6">Coming Soon!</p>
        <p className="text-gray-400 mb-8">
          We're building powerful AI creation tools. Stay tuned for video generation, chatbot builder, and more.
        </p>
